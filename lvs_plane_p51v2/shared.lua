...
function ENT:InitWeapons()
    self.PosTPMG = {
        Vector(70.78,79.35,63.07),
        Vector(70.78,-79.35,63.07),
        Vector(70.74,-88.45,63.69),
        Vector(70.74,88.45,63.69),
        Vector(70.88,97.43,64.43),
        Vector(70.88,-97.43,64.43),
    }
    self.DirTPMG = { 0.5, -0.5, -0.5, 0.5, 0.4, -0.4 }
    self:AddWeapon( LVS:GetWeaponPreset( "TABLE_POINT_MG" ) )

    -- Missiles: AI-unusable (UseableByAI = false), pilot-only
    local weapon = {}
...
ENT.ExhaustPositions = {
    { pos = Vector(131,20.5,84),  ang = Angle(-90,-20,0) },
    { pos = Vector(125,20.5,84),  ang = Angle(-90,-20,0) },
    { pos = Vector(119,20.5,84),  ang = Angle(-90,-20,0) },
    { pos = Vector(113,20.5,84),  ang = Angle(-90,-20,0) },
    { pos = Vector(107,20.5,84),  ang = Angle(-90,-20,0) },
    { pos = Vector(101,20.5,84),  ang = Angle(-90,-20,0) },
    { pos = Vector(131,-20.5,84), ang = Angle(-90,20,0)  },
    { pos = Vector(125,-20.5,84), ang = Angle(-90,20,0)  },
    { pos = Vector(119,-20.5,84), ang = Angle(-90,20,0)  },
    { pos = Vector(113,-20.5,84), ang = Angle(-90,20,0)  },
